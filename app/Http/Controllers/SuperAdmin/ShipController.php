...
class ShipController extends Controller
{
    ...
    public function create(Request  $request)
    {
        if(isset($request->branch_id)){
            $ships =  Ships::with('createdBy','shipmentStatus','shipmentMethodTypes','portOfOrigins','portOfDestinations','clearingAgents')->where('branch_id', $request->branch_id)->orderBy('id', 'desc')->paginate(10);
            ...
            $agents = Agencies::all();
            return view('superadmin.ships.create', compact('staffs', 'ships', 'shipmentTypes', 'ports', 'agents','statuses','branches'));
        }
        else{
            $ships =  Ships::with('createdBy','shipmentStatus','shipmentMethodTypes','portOfOrigins','portOfDestinations','clearingAgents')->orderBy('id', 'desc')->paginate(10);
            $staffs = Staffs::notadmin()->get();
            $shipmentTypes = ShipTypes::all();
            $branches = Branches::all();
            $statuses = status_list_admin(); //Statuses::get();
    ...
    public function store(Request $request)
    {
        ...
        return  redirect()->route('superadmin.ship.create');
        }
    ...
    public function show($id)
    {
        ...
        return view('superadmin.ships.create', compact('bookings'));
    ...
    public function edit($id)
    {
        ...
        return view('superadmin.shipments.edit', compact('shipment', 'agencies', 'origin_offices', 'countries','drivers'));
    ...
    public function print($id){
        ...
        return view('superadmin.shipments.printview', compact('shipment'));
    }
    ...
    public function viewManifesto(Request $request, $id) {
        ...
        return view('superadmin.ships.viewManifesto',compact('id','ships','getShips','statuses'));
    }
...
// dd(branch()->id );
        ...
        return view('superadmin.ships.manifestoView',compact('id','boxes', 'branches', 'drivers', 'tripsheets','statuses','getShips'));
    }
    ...
    public function editShip($id) {
        ...
        $ports = PortOfOrigins::where('status',1)->get();
        $agents = Agencies::all();
        return view('superadmin.ships.editShips', compact('staffs', 'ship', 'shipmentTypes', 'ports', 'agents','statuses'));
    }
    ...
    public function detailedView($id) {
        ...
        // return $shipBookings;
        return view('superadmin .ships.detailedView', compact('shipment','shipBookings'));
    }
}
