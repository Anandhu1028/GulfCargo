...
<a href="#" id="btn-Convert-Html2Image" onclick="printTIFF({{$i}})" class="btn btn-info" style="display:none;">TIFF</a>
    ...
    <div class=" mt-2 {{ $first_loop == false ? 'printable-invoice' : 'p-3 ' }}" id="" style="">
        <div class="above_main_div" id="myElement{{$i}}" inv_no{{$i}}={{$item->box_name}} style="background-color: #fff !important; display: flex;
 ...
 <script>
var  loop_count = 0;
var totalCount = Number("<?php echo count($shipment->boxes) ?>");
