                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        $.each(result.states, function (key, value) {
                            var isSelected = value.name === '{{ $customer->address->state->name }}' ? ' selected' : '';
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $.each(result, function (key, value) {
                    var isSelected = value.name === '{{ $customer->address->district->name??'' }}' ? ' selected' : '';
                    $("#district_id").append('<option value="' + value.id + '"' + isSelected + '>' + value.name + '</option>');
