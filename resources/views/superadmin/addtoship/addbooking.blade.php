                            ...
                            <div class="body">
                                ...
                                <div class="col-md-12 text-right ">
                                    ...
                                    <div class="row floatRight" >
                                        <a  href="{{route('super-admin.ships.deliverylistptint', array('ship_id' => $ships->id))}}" class="btn btn-success mr-3 mb-1"> Delivery List</a>
                                        <a  href="{{route('super-admin.ships.packinglistptint', array('ship_id' => $ships->id))}}" class="btn btn-success mr-3 mb-1"> Packing List </a>
                                        <a  href="{{route('super-admin.ships.customermanifestptint', array('ship_id' => $ships->id))}}" class="btn btn-success mr-3 mb-1"> Customs Manifest</a>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content w-75">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('super-admin.shipment.printall') }}" method="post" target="_blank">
                                                            @csrf
                                                            @foreach ($ship_bookingsList as $booking)
                                        ...
                                        <form action="{{route('super-admin.shipment.loadingExport')}}" class="m-l-10" method="post" target="_blank">
                                            @csrf
                                ...
                                <div class="table-responsive">
                                    <table id="shipsTable" class="table table-striped table-bordered nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        $totalPieces =0;
                                        $boxList = [];
                                        foreach( $ship_bookingsList as $itration=>$booking) {
                                            ...
                                            <tr style="{{ $style }}">
                                                ...
                                                <td>
                                                    ...
                                                    <a href="/branch/shipment/single_print/{{$booking->id}}" title="Print" target="_blank" id="printInv{{$itration}}"
                                                    class="btn btn-icon waves-effect waves-light btn-success icons">
                                        ...
                                        ?>
                                            <tr>
                                                <td  colspan="4"> </td><td style="text-align:center">{{ $totalPieces}}</td>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/js/bootstrap.bundle.min.js"></script>
    ...
    $(document).ready(function () {
        ...
        $(function () {
            ...
            // let shipBookingsCount = {{ count($ship_bookingsList) }};

            // $('#printAllSingleView').click(function (e) {
            //     e.preventDefault(); // Prevent the default action if necessary

            //     for(let i = 0; i < shipBookingsCount; i++) {
            //         $('#printInv' + i).click();
            //     }
            // });
            ...
            $(document).on('click', '.updateStatus', function(){
                var url = "{{route('super-admin.ships.multiUpdatebookingtoship')}}";
